...
* [ ] **1.1: Environment Setup**
    * [ ] 1.1.1: Initialize a Git repository with `git init`.
    * [ ] 1.1.2: Create a corresponding repository on GitHub and push the initial commit.
    * [ ] 1.1.3: Create a `.gitignore` file to exclude common files (`__pycache__`, `node_modules`, `.vscode`, `*.env`, etc.).

* [ ] **1.2: Project Directory Structure**
    * [ ] 1.2.1: Create a root project folder.
    * [ ] 1.2.2: Inside the root, create a `backend` folder for all Python code.
    * [ ] 1.2.3: Inside the root, create an `extension` folder for all VS Code extension code (TypeScript/JavaScript).
